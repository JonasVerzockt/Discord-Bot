...
from utils.availability import load_shop_data, available_variants, strip_html, ensure_url_scheme, format_rating, is_live_ant_species, is_merch_product
...
class OffersCog(commands.Cog, name="Offers"):
    ...
    async def offers(
        ...
        prods = [
            ...
            and not is_merch_product(p)  # Merch/Präparate raus (auch Poster o.Ä. im Titel/Variante)
        ]
        if not prods:
