...
| `/codes_rescan` | `force` (optional) | Rabattcode-Kanal erneut scannen. `force=true` löscht die Scan-Historie und parst alle Nachrichten erneut (kostet Haiku-Aufrufe). |
