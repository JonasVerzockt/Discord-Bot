...
T: dict[str, dict[str, str]] = {
    ...
    "exp_av_hardest": {"de": "Arten, die breit gelistet, aber selten lagernd sind (ab 5 Shops).", "en": "Species widely listed but rarely in stock (min. 5 shops).", "eo": "Specioj vaste listigitaj sed malofte en stoko (min. 5 butikoj)."},
    ...
    "exp_dq_shop_adjusted": {"de": "Shops, deren Rohnamen am häufigsten korrigiert werden mussten (ab 20 Angeboten).", "en": "Shops whose raw names most often needed correction (min. 20 offers).", "eo": "Butikoj, kies krudaj nomoj plej ofte bezonis korekton (min. 20 ofertoj)."},
