...
T: dict[str, dict[str, str]] = {
    ...
    "exp_price_spread_small": {"de": "Arten mit der kleinsten Preisspanne über die Shops (nahezu einheitlicher Preis, Spanne ≈ 0). Der Balken zeigt diesen Preis.", "en": "Species with the smallest price range across shops (near-uniform price, range ≈ 0). The bar shows that price.", "eo": "Specioj kun la plej malgranda prezintervalo tra la butikoj (preskaŭ unueca prezo, intervalo ≈ 0). La stango montras tiun prezon."},
