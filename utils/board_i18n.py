...
T: dict[str, dict[str, str]] = {
    ...
    "exp_price_spread_small": {"de": "Arten mit der kleinsten Preisspanne über die Shops (Preis fast überall gleich). Tabelle mit Preisbereich (min–max), Spanne (Δ) und Shop-Anzahl.", "en": "Species with the smallest price range across shops (price almost identical everywhere). Table with price range (min–max), range (Δ) and number of shops.", "eo": "Specioj kun la plej malgranda prezintervalo tra la butikoj (prezo preskaŭ ĉie sama). Tabelo kun prezintervalo (min–max), intervalo (Δ) kaj nombro de butikoj."},
